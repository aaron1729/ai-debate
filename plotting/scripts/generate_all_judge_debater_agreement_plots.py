...
def main():
    ...
    output_dir = os.path.join(project_root, 'plotting', 'plots', 'judge-debater-agreement')
    ...
    print(f'\n✓ All {len(models) * len(models)} judge-debater agreement plots generated successfully!')
    return 0
