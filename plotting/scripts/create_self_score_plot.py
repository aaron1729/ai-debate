...
def create_self_score_plot(model_id, output_filename, full_debate_only=False):
    ...
    # Plot 1: All scores
    axes[0].hist(all_scores, bins=bins, color=model_color, alpha=0.7, edgecolor='black')
    ...
    axes[1].hist(pro_scores, bins=bins, color=model_color, alpha=0.7, edgecolor='black')
    ...
    axes[2].hist(con_scores, bins=bins, color=model_color, alpha=0.7, edgecolor='black')
