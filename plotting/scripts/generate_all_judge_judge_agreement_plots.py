...
def main():
    parser = argparse.ArgumentParser(description='Generate judge-judge agreement plots for all pairs')
    ...
    for i, (judge1_id, judge1_name) in enumerate(models_sorted):
        for judge2_id, judge2_name in models_sorted[i+1:]:
            ...
            try:
                create_judge_judge_agreement_plot(judge1_id, judge2_id, output_path, use_bubble=args.bubble)
    ...
    print(f'\n✓ All {total_pairs} judge-judge agreement {plot_type_name} generated successfully!')
    return 0
