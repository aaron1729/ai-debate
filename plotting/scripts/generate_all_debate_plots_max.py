#!/usr/bin/env python3
"""Generate debate plots (using MAX judgment IDs) for all fully-judged debate motions."""
...
def main():
    ...
    output_dir = os.path.join(project_root, 'plotting', 'plots', 'debate-motions-with-duplicate-judging')
...
from create_debate_plot_max import create_debate_plot
