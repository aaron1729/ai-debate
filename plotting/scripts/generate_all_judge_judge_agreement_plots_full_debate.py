...
def main():
    ...
    for i, (judge1_id, judge1_name) in enumerate(models_sorted):
        for judge2_id, judge2_name in models_sorted[i+1:]:
            ...
            try:
                create_judge_judge_agreement_plot(judge1_id, judge2_id, output_path, full_debate_only=True)
    ...
    print(f'\n✓ All {total_pairs} full-debate-only judge-judge agreement plots generated successfully!')
    return 0
